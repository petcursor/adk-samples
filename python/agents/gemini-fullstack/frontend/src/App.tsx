        ...
        <div className="text-center space-y-6">
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="relative">
              <div className="w-16 h-16 border-4 border-neutral-600 border-t-pwc-orange rounded-full animate-spin"></div>
              <div className="absolute inset-0 w-16 h-16 border-4 border-transparent border-r-pwc-orange rounded-full animate-spin" style={{animationDirection: 'reverse', animationDuration: '1.5s'}}></div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-neutral-400">
                Please wait while we prepare your AI research environment
              </p>
            </div>
            
            {/* Animated dots */}
            <div className="flex space-x-1">
              <div className="w-2 h-2 bg-pwc-orange rounded-full animate-bounce" style={{animationDelay: '0ms'}}></div>
              <div className="w-2 h-2 bg-pwc-orange rounded-full animate-bounce" style={{animationDelay: '150ms'}}></div>
              <div className="w-2 h-2 bg-pwc-orange rounded-full animate-bounce" style={{animationDelay: '300ms'}}></div>
            </div>
          </div>
        </div>
      </div>
