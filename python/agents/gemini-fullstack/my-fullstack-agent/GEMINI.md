...
```
your_project_root/
â”œâ”€â”€ my_first_agent/             # Each folder is a distinct agent app
â”‚   â”œâ”€â”€ __init__.py             # Makes `my_first_agent` a Python package (`from . import agent`)
â”‚   â”œâ”€â”€ agent.py                # Contains `root_agent` definition and `LlmAgent`/WorkflowAgent instances
â”‚   â”œâ”€â”€ tools.py                # Custom tool function definitions
â”‚   â”œâ”€â”€ data/                   # Optional: static data, templates
â”‚   â””â”€â”€ .env                    # Environment variables (API keys, project IDs)
â”œâ”€â”€ my_second_agent/
â”‚   â”œâ”€â”€ __init__.py
â”‚   â””â”€â”€ agent.py
â”œâ”€â”€ requirements.txt            # Project's Python dependencies (e.g., google-adk, litellm)
â”œâ”€â”€ tests/                      # Unit and integration tests
â”‚   â”œâ”€â”€ unit/
â”‚   â”‚   â””â”€â”€ test_tools.py
â”‚   â””â”€â”€ integration/
â”‚       â””â”€â”€ test_my_first_agent.py
â”‚       â””â”€â”€ my_first_agent.evalset.json # Evaluation dataset for `adk eval`
â””â”€â”€ main.py                     # Optional: Entry point for custom FastAPI server deployment
```
...
# Root
# â””â”€â”€ Coordinator (LlmAgent)
#     â”œâ”€â”€ SalesAgent (LlmAgent)
#     â””â”€â”€ SupportAgent (LlmAgent)
#     â””â”€â”€ DataPipeline (SequentialAgent)
#         â”œâ”€â”€ DataFetcher (LlmAgent)
#         â””â”€â”€ DataProcessor (LlmAgent)
```
...
*   **Standard Workflow:**
    The validated end-to-end process is: `create` â†’ `test` â†’ `setup-cicd` â†’ push to deploy. Trust this high-level workflow as the default for developing and shipping agents.
